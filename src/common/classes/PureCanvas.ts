...
export default class PureCanvas {
  ...
  protected _updateSource(canvas: HTMLCanvasElement): void {
    this._canvas = canvas;
  ...
  public applyOptions(options: PureCanvasOptions): void {
  ...
  public async fromURL(dataURL: string, getImageSize: boolean = false): Promise<void> {
